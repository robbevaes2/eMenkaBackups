    ...
    public class DataBaseSeeder
    {
        public static void SeedData(ModelBuilder builder)
        {
            ...
            builder.Entity<Country>().HasData(
                ...
                new Country
                {
                    Id = 2, Name = "Nederland", Code = "NL", Nationality = "Nederlandse", POD = true, IsActive = true
                },
                new Country
                {
                    Id = 3, Name = "Duitsland", Code = "DE", Nationality = "Duitse", POD = false, IsActive = true
                },
                new Country
                {
                    Id = 4, Name = "Frankrijk", Code = "FR", Nationality = "Franse", POD = false, IsActive = true
                },
                new Country
                {
                    Id = 5, Name = "Spanje", Code = "ES", Nationality = "Spaanse", POD = false, IsActive = false
                }
            );
            ...
            builder.Entity<Company>().HasData(
                new Company
                {
                    Id = 1, Name = "Total Belgium", IsInternal = false, IsActive = false, AccountNumber = null
                },
                new Company
                {
                    Id = 2, Name = "Esso", Description = "Esso", Reference = "Esso", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "123", AccountNumber = "123"
                },
                new Company {Id = 3, Name = "Shell", IsInternal = false, IsActive = false, AccountNumber = null},
                new Company
                {
                    Id = 4, Name = "OpelPlus", Description = "Fictieve Opel garage", Reference = "Garage opel",
                    IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "BE0456.565.667",
                    AccountNumber = "333-7777777-22"
                },
                new Company
                {
                    Id = 5, Name = "AVIS", Description = "KT leverancier ?", Reference = "AVIS", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "BE 0455664455556", AccountNumber = "123-1234567-98"
                },
                new Company
                {
                    Id = 6, Name = "Texaco", Description = "Texaco", Reference = "Texaco", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "2", AccountNumber = "2"
                },
                new Company {Id = 7, Name = "Q8", IsInternal = false, IsActive = false, AccountNumber = null},
                new Company
                {
                    Id = 8, Name = "CIACfleet", Description = "Multimerkverhuurder", Reference = "CIAC",
                    IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "xx", AccountNumber = "xx"
                },
                new Company
                {
                    Id = 9, Name = "Sneyers", Description = "BMW Garage", Reference = "D", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "1", AccountNumber = "1"
                },
                new Company
                {
                    Id = 10, Name = "AXA", Description = "AXA", Reference = "AXA", IsInternal = false, IsActive = true,
                    NonActiveRemark = "", VAT = "1", AccountNumber = "1"
                },
                new Company
                {
                    Id = 11, Name = "VAB", Description = "VAB", Reference = "VAB", IsInternal = false, IsActive = true,
                    NonActiveRemark = "", VAT = "1", AccountNumber = "1"
                },
                new Company
                {
                    Id = 12, Name = "Touring", Description = "Touring", Reference = "Touring", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "2", AccountNumber = "2"
                },
                new Company
                {
                    Id = 13, Name = "Brocom", Description = "Brocom", Reference = "Brocom", IsInternal = false,
                    IsActive = false, NonActiveRemark = "tijdelijk niet acief gezet", VAT = "BE 123233134234",
                    AccountNumber = "123-123456789-12"
                },
                new Company
                {
                    Id = 14, Name = "KBC Autolease", Description = "KBC", Reference = "KBC", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "BE 0422.562.385",
                    AccountNumber = "BE30 4377 5013 7111"
                },
                new Company
                {
                    Id = 15, Name = "Mercedes-Benz FS Belux NV", Description = "Daimler Fleet Management",
                    Reference = "MBFS", IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "BE0405816821",
                    AccountNumber = "BE42 4829 0171 1154"
                },
                new Company
                {
                    Id = 16, Name = "GMAN Antwerpen", IsInternal = false, IsActive = false, AccountNumber = null
                },
                new Company
                {
                    Id = 17, Name = "Mercator Verzekeringen NV", Description = "", Reference = "Mercator",
                    IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "BE0400.048.883",
                    AccountNumber = "BE31 4100 0007 1155"
                },
                new Company
                {
                    Id = 18, Name = "KAVEDE NV", Description = "", Reference = "KAVEDE", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "BE0429.270.926", AccountNumber = ""
                },
                new Company
                {
                    Id = 19, Name = "Peter DAENINCK NV", Description = "BMW dealer", Reference = "", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company
                {
                    Id = 20, Name = "Carglass", Description = "Carglass", Reference = "CAR", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "BE 0432.023.845", AccountNumber = "335-0431795-94"
                },
                new Company
                {
                    Id = 21, Name = "FodFin", Description = "Federale overheidsdienst Financiën", Reference = "FODFIN",
                    IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company
                {
                    Id = 22, Name = "Patrick Smets NV", Description = "Gar BMW Smets", Reference = "SMETS",
                    IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "BE 0418.022.587",
                    AccountNumber = "001-4327984-17"
                },
                new Company
                {
                    Id = 23, Name = "Beerens", Description = "", Reference = "", IsInternal = false, IsActive = true,
                    NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company
                {
                    Id = 24, Name = "Jespers", Description = "Bandencentrale", Reference = "TYRECENTER",
                    IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "BE39416100572119",
                    AccountNumber = ""
                },
                new Company
                {
                    Id = 25, Name = "Autokeuring", Description = "algemeen naam", Reference = "", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company
                {
                    Id = 26, Name = "Euromex", Description = "rechtsbijstand", Reference = "", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "BE0404493859", AccountNumber = ""
                },
                new Company
                {
                    Id = 27, Name = "DAS", Description = "rechtsbijstandsverzekering", Reference = "",
                    IsInternal = false, IsActive = true, NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company
                {
                    Id = 28, Name = "Maecon", Description = "Maecon", Reference = "", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company
                {
                    Id = 29, Name = "eMenKa NV", Description = "", Reference = "", IsInternal = true, IsActive = true,
                    NonActiveRemark = "", VAT = "BE 0888.140.116", AccountNumber = ""
                },
                new Company
                {
                    Id = 30, Name = "Moereels", Description = "banden donckers", Reference = "", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "BE80230013411177", AccountNumber = ""
                },
                new Company
                {
                    Id = 31, Name = "eMenKa GmbH", Description = "", Reference = "", IsInternal = true, IsActive = true,
                    NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company
                {
                    Id = 32, Name = "eMenKa BV",
                    Description =
                    ...
                    Reference = "", IsInternal = true, IsActive = true, NonActiveRemark = "", VAT = "",
                    AccountNumber = ""
                },
                new Company
                {
                    Id = 33, Name = "test", Description = "test", Reference = "", IsInternal = false, IsActive = true,
                    NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
                new Company {Id = 34, Name = "Q8", IsInternal = false, IsActive = false, AccountNumber = null},
                new Company
                {
                    Id = 35, Name = "Alphabet", Description = "", Reference = "ALP", IsInternal = false,
                    IsActive = true, NonActiveRemark = "", VAT = "", AccountNumber = ""
                },
            ...
            builder.Entity<Corporation>().HasData(
                new Corporation
                {
                    Id = 1, Name = "eMenKa BV", Abbreviation = "Holland", CompanyId = 32,
                    StartDate = new DateTime(2010, 1, 1, 12, 0, 0)
                },
                new Corporation
                {
                    Id = 2, Name = "eMenKa GmbH", Abbreviation = "Keulen", CompanyId = 31,
                    StartDate = new DateTime(2010, 1, 1, 12, 0, 0)
                },
                new Corporation
                {
                    Id = 3, Name = "eMenKa NV", Abbreviation = "Antwerpen", CompanyId = 29,
                    StartDate = new DateTime(2010, 1, 1, 12, 0, 0)
                }
            );
            ...
            builder.Entity<Driver>().HasData(
                ...
                new Driver
                {
                    Id = 2, PersonId = 6, StartDate = new DateTime(2007, 09, 1), EndDate = new DateTime(2009, 06, 25),
                    FuelCardId = 2
                },
                new Driver
                {
                    Id = 3, PersonId = 9, StartDate = new DateTime(2009, 05, 13), EndDate = new DateTime(2011, 01, 13),
                    FuelCardId = 3
                },
                new Driver
                {
                    Id = 4, PersonId = 4, StartDate = new DateTime(2008, 03, 16), EndDate = new DateTime(2010, 11, 30),
                    FuelCardId = 4
                },
                new Driver
                {
                    Id = 5, PersonId = 1, StartDate = new DateTime(2008, 09, 16), EndDate = new DateTime(2015, 02, 28),
                    FuelCardId = 5
                },
                new Driver
                {
                    Id = 6, PersonId = 10, StartDate = new DateTime(2007, 08, 5), EndDate = new DateTime(2010, 04, 16),
                    FuelCardId = 6
                },
                new Driver {Id = 7, PersonId = 3, StartDate = new DateTime(2007, 06, 1), FuelCardId = 7},
                new Driver
                {
                    Id = 8, PersonId = 11, StartDate = new DateTime(2009, 06, 15), EndDate = new DateTime(2011, 09, 30),
                    FuelCardId = 8
                },
                new Driver
                {
                    Id = 9, PersonId = 12, StartDate = new DateTime(2008, 10, 6), EndDate = new DateTime(2010, 03, 1),
                    FuelCardId = 9
                },
                new Driver {Id = 10, PersonId = 13, StartDate = new DateTime(2009, 09, 14), FuelCardId = 10},
                new Driver
                {
                    Id = 11, PersonId = 14, StartDate = new DateTime(2007, 09, 17),
                    EndDate = new DateTime(2008, 06, 30), FuelCardId = 11
                },
                new Driver
                {
                    Id = 12,
            ...
            builder.Entity<Vehicle>().HasData(
                new Vehicle
                {
                    ...
                    InteriorColorId = 1, ExteriorColorId = 1
                },
                new Vehicle
                {
            ...
            builder.Entity<FuelCard>().HasData(
                new FuelCard
                {
                    Id = 1, DriverId = 1, Number = "188395479", CompanyId = 16,
                    StartDate = new DateTime(2008, 11, 6, 11, 0, 0, 0), EndDate = new DateTime(2008, 12, 20),
                    IsBlocked = true, BlockingDate = new DateTime(2009, 3, 25),
                    BlockingReason = "kaart niet meer geldig", PinCode = "1011"
                },
                new FuelCard
                {
                    Id = 2, DriverId = 2, Number = "0008 Tankkaartje 555", CompanyId = 4,
                    StartDate = new DateTime(2007, 12, 12), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2010, 5, 18), BlockingReason = "vervanging", PinCode = "****888"
                },
                new FuelCard
                {
                    Id = 3, DriverId = 3, Number = "0005 AANLOOP 4", CompanyId = 6,
                    StartDate = new DateTime(2007, 9, 14), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2020, 6, 3), BlockingReason = "", PinCode = "****"
                },
                new FuelCard
                {
                    Id = 4, DriverId = 4, Number = "0004 AANLOOP 3", CompanyId = 4,
                    StartDate = new DateTime(2007, 8, 13), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2010, 3, 18), BlockingReason = "vervanging", PinCode = "7293"
                },
                new FuelCard
                {
                    Id = 5, DriverId = 5, Number = "0010 AANLOOP 88", CompanyId = 4,
                    StartDate = new DateTime(2008, 1, 17), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2020, 4, 3), BlockingReason = "", PinCode = "****"
                },
                new FuelCard
                {
                    Id = 6, DriverId = 6, Number = "0009 AANLOOP 7", CompanyId = 4,
                    StartDate = new DateTime(2009, 4, 1), EndDate = new DateTime(2010, 5, 18), IsBlocked = false,
                    BlockingDate = new DateTime(2020, 3, 3), BlockingReason = "", PinCode = "14589"
                },
                new FuelCard
                {
                    Id = 7, DriverId = 7, Number = "0002 AANLOOP 1", CompanyId = 4,
                    StartDate = new DateTime(2007, 5, 22), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2010, 5, 18), BlockingReason = "vervanging", PinCode = "2937"
                },
                new FuelCard
                {
                    Id = 8, DriverId = 8, Number = "0003 AANLOOP 2", CompanyId = 4,
                    StartDate = new DateTime(2007, 8, 1), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2010, 5, 18), BlockingReason = "vervanging", PinCode = "3177"
                },
                new FuelCard
                {
                    Id = 9, DriverId = 9, Number = "0001 LUVA", CompanyId = 4, StartDate = new DateTime(2007, 5, 22),
                    EndDate = new DateTime(2010, 5, 18), IsBlocked = true, BlockingDate = new DateTime(2010, 5, 18),
                    BlockingReason = "vervanging", PinCode = "7846"
                },
                new FuelCard
                {
                    Id = 10, DriverId = 10, Number = "0006 SALES", CompanyId = 23,
                    StartDate = new DateTime(2007, 9, 19), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2010, 5, 18), BlockingReason = "vervanging", PinCode = "****"
                },
                new FuelCard
                {
                    Id = 11, DriverId = 11, Number = "0007 AANLOOP 5", CompanyId = 4,
                    StartDate = new DateTime(2007, 10, 31), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2010, 5, 18), BlockingReason = "vervanging", PinCode = "****"
                },
                new FuelCard
                {
                    Id = 12, DriverId = 12, Number = "0011 AANLOOP 9", CompanyId = 4,
                    StartDate = new DateTime(2008, 2, 7), EndDate = new DateTime(2010, 5, 18), IsBlocked = true,
                    BlockingDate = new DateTime(2010, 5, 18), BlockingReason = "vervanging", PinCode = "****"
                },
                new FuelCard
                {
                    Id = 13, DriverId = 13, Number = "0012 AANLOOP 10", CompanyId = 4,
                    StartDate = new DateTime(2008, 9, 12), EndDate = new DateTime(2011, 11, 9), IsBlocked = true,
                    BlockingDate = new DateTime(2009, 4, 21), BlockingReason = "verloren", PinCode = "604"
                },
                new FuelCard
                {
                    Id = 14, DriverId = 14, Number = "0009", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "7008"
                },
                new FuelCard
                {
                    Id = 15, DriverId = 15, Number = "0002", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "2938"
                },
                new FuelCard
                {
                    Id = 16, DriverId = 16, Number = "0003", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    EndDate = new DateTime(2018, 8, 17), IsBlocked = false, BlockingReason = "", PinCode = "3177"
                },
                new FuelCard
                {
                    Id = 17, DriverId = 17, Number = "0004", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    EndDate = new DateTime(2019, 2, 1), IsBlocked = false, BlockingReason = "", PinCode = "7293"
                },
                new FuelCard
                {
                    Id = 18, DriverId = 18, Number = "0005", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = true, BlockingDate = new DateTime(2017, 8, 23), BlockingReason = "test", PinCode = "321"
                },
                new FuelCard
                {
                    Id = 19, DriverId = 19, Number = "0006", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "4606"
                },
                new FuelCard
                {
                    Id = 20, DriverId = 20, Number = "0007", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "6491"
                },
                new FuelCard
                {
                    Id = 21, DriverId = 21, Number = "0008", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "401"
                },
                new FuelCard
                {
                    Id = 22, DriverId = 22, Number = "0010", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "7861"
                },
                new FuelCard
                {
                    Id = 23, DriverId = 23, Number = "0011", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = true, BlockingDate = new DateTime(2017, 8, 23), BlockingReason = "ok", PinCode = "9714"
                },
                new FuelCard
                {
                    Id = 24, DriverId = 24, Number = "0139", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "9183"
                },
                new FuelCard
                {
                    Id = 25, DriverId = 25, Number = "0014", CompanyId = 4, StartDate = new DateTime(2010, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "6325"
                },
                new FuelCard
                {
                    Id = 26, DriverId = 26, Number = "0019", CompanyId = 4, StartDate = new DateTime(2012, 8, 13),
                    IsBlocked = false, BlockingReason = "", PinCode = "3030"
                },
                new FuelCard
                {
                    Id = 27, DriverId = 27, Number = "0020", CompanyId = 4, StartDate = new DateTime(2012, 8, 20),
                    IsBlocked = false, BlockingReason = "", PinCode = "3315"
                },
                new FuelCard
                {
                    Id = 28, DriverId = 28, Number = "0100", CompanyId = 4, StartDate = new DateTime(2013, 12, 9),
                    IsBlocked = false, BlockingReason = "", PinCode = "7491"
                },
                new FuelCard
                {
                    Id = 29, DriverId = 29, Number = "0021", CompanyId = 4, StartDate = new DateTime(2013, 9, 12),
                    IsBlocked = false, PinCode = "9363"
                },
                new FuelCard
                {
                    Id = 30, DriverId = 30, Number = "0017", CompanyId = 4, StartDate = new DateTime(2012, 2, 24),
                    IsBlocked = false, PinCode = "1312"
                },
                new FuelCard
                {
                    Id = 31, DriverId = null, Number = "0129", CompanyId = 4, StartDate = new DateTime(2012, 2, 24),
                    IsBlocked = false, BlockingReason = "", PinCode = "2765"
                },
                new FuelCard
                {
                    Id = 32, DriverId = null, Number = "0016", CompanyId = 4, StartDate = new DateTime(2011, 5, 19),
                    IsBlocked = false, BlockingReason = "", PinCode = "535"
                },
                new FuelCard
                {
                    Id = 33, DriverId = null, Number = "0023", CompanyId = 4, StartDate = new DateTime(2016, 1, 1),
                    IsBlocked = false, PinCode = "****"
                },
                new FuelCard
                {
                    Id = 34, DriverId = null, Number = "0001", CompanyId = 15, StartDate = new DateTime(2017, 4, 25),
                    EndDate = new DateTime(2020, 5, 4), IsBlocked = true, BlockingDate = new DateTime(2020, 4, 20),
                    BlockingReason = "Vervangen door nieuwe tankkaart", PinCode = "123456"
                },
                new FuelCard
                {
                    Id = 35, DriverId = null, Number = "1234", CompanyId = 4, StartDate = new DateTime(2014, 4, 26),
                    IsBlocked = false, BlockingReason = "", PinCode = "1234"
                },
                new FuelCard
                {
                    Id = 36, DriverId = null, Number = "Test", CompanyId = 24, StartDate = new DateTime(2020, 4, 3),
                    IsBlocked = false, PinCode = "12345678"
                },
                new FuelCard
                {
                    Id = 37, DriverId = null, Number = "008", CompanyId = 19, StartDate = new DateTime(2020, 3, 25),
                    IsBlocked = false, PinCode = "88"
                },
                new FuelCard
                {
                    Id = 38, DriverId = null, Number = "Test Nummer", CompanyId = 19,
                    StartDate = new DateTime(2020, 1, 3), IsBlocked = false, PinCode = "1234"
                },
                new FuelCard
                {
                    Id = 39, DriverId = null, Number = "123456789", CompanyId = 19,
                    StartDate = new DateTime(2020, 3, 14), EndDate = new DateTime(2022, 3, 7), IsBlocked = false,
                    PinCode = "8896"
                }
            );
            ...
            builder.Entity<CostAllocation>().HasData(
                ...
                new CostAllocation
                {
                    Id = 2, Name = "Hasselt", Abbreviation = "Lim", StartDate = new DateTime(), EndDate = new DateTime()
                },
                new CostAllocation
                {
                    Id = 3, Name = "Brussel", Abbreviation = "Bxl", StartDate = new DateTime(), EndDate = new DateTime()
                },
                new CostAllocation
                {
                    Id = 4, Name = "Antwerpen", Abbreviation = "HQ", StartDate = new DateTime(),
            ...
            builder.Entity<Record>().HasData(
                ...
                new Record
                {
                    Id = 6, CorporationId = 3, CostAllocationId = 2, FuelCardId = 9,
                    StartDate = new DateTime(2020, 1, 20), EndDate = new DateTime(2023, 1, 20), Term = Term.Long,
                    Usage = Usage.Definitive
                },
                new Record
                {
