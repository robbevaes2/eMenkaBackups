...
namespace eMenka.API.Controllers
{
    ...
    public class FuelCardController : ControllerBase
    {
        ...
        public IActionResult GetAllFuelCards()
        {
            ...
            return Ok(fuelCards.Select(FuelCardMapper.MapFuelCardEntity).ToList());
        }
        ...
        public IActionResult GetFuelCardById(int id)
        {
            ...
            return Ok(FuelCardMapper.MapFuelCardEntity(fuelCard));
        }
        ...
        public IActionResult PostFuelCard([FromBody] FuelCardModel fuelCardModel)
        {
            ...
            _fuelCardRepository.Add(FuelCardMapper.MapFuelCardModel(fuelCardModel));
            return Ok();
        }
        ...
        public IActionResult UpdateFuelCard([FromBody] FuelCardModel fuelCardModel, int id)
        {
            ...
            var isUpdated = _fuelCardRepository.Update(id, FuelCardMapper.MapFuelCardModel(fuelCardModel));
